...
partial_namelist = [x.decode('utf-8') for x in partial_namelist]


# FIXME: These tests were not made to handle including assets with missing names.
#         I commented out most of the problematic lines


def test_load_pack2():
    pack2v1 = Pack2(Path('data_x64_0_with_namelist.pack2'))
