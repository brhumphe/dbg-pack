...
def test_pack1_read():
    a1 = Asset1(name='AbilityClasses.txt', offset=8192, data_length=149, crc32=1748740018, path=Path('sample.pack'))
...
def test_pack2_read():
    ...
    a2 = Asset2(name_hash=4696632789834285999, offset=512, data_length=97, crc32=1187660072,
