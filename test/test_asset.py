...
def test_pack1_read():
    a1 = Asset1(name='AbilityClasses.txt', offset=8192, data_length=149, hash=1748740018, path=Path('sample.pack'))
    # Make sure data read is correctly from a pack1 file
    assert a1.get_data() == SAMPLE_DATA
    assert a1.hash == binascii.crc32(a1.get_data())
...
def test_pack2_read():
    ...
    a2 = Asset2(name_hash=4696632789834285999, offset=512, data_length=97, hash=1187660072,
